...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row">
		<?php echo CHtml::activeLabelEx($model,'ref_period_begin_date'); ?>
		<?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
			    'model'=>$model,
			    'attribute'=>'ref_period_begin_date',
			    // additional javascript options for the date picker plugin
			    'options'=>array(
			        'dateFormat'=>'yy-mm-dd',
			    ),
		 ...
		 ?>
		<?php echo CHtml::error($model,'ref_period_begin_date'); ?>
	</div>

	<div class="row">
		<?php echo CHtml::activeLabelEx($model,'ref_period_end_date'); ?>
        <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                'model'=>$model,
                'attribute'=>'ref_period_end_date',
                // additional javascript options for the date picker plugin
                'options'=>array(
                    'dateFormat'=>'yy-mm-dd',
                ),
         ...
         ?>
		<?php echo CHtml::error($model,'ref_period_end_date'); ?>
	</div>
